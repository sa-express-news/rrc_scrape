require_relative 'requirements'
 ...
 filenames = Dir["ewa/*/leases/cnty_pd/*.html"]


# filenames = [ 'ewa/BEE/leases/cnty_pd/cnty_pd_09250.html', 
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_00428.html', 
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_00717.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_001029.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_001046.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_01260.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_02002.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_02031.html',
#               'ewa/LIVE OAK/leases/cnty_pd/cnty_pd_17034.html',
#               'ewa/MCMULLEN/leases/cnty_pd/cnty_pd_17034.html',
#               'ewa/LIVE OAK/leases/cnty_pd/cnty_pd_09944.html',
#               'ewa/KARNES/leases/cnty_pd/cnty_pd_09944.html'
#               ]   


CSV.open("processed_disps/ewa_cnty_pd.csv", "ab") do |csv|
    filenames.each do |file|
        ...
        begin
          ...
          File.open('processed_disps/error_file.txt', 'a') { |f| f.write("#{file}\n") }
          next
        end
